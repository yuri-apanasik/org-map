...
export const STATIC_JOB_ASSIGNMENTS: OrgTreeAssignment[] = [
  ...
  { personId: 'AT', sourceNodeIds: ['NJS'], targetNodeIds: ['IRIS'] },
  ...
  { personId: 'DB', sourceNodeIds: ['AND'], targetNodeIds: ['IRIS'] },
  ...
  { personId: 'NS', sourceNodeIds: ['PM'], targetNodeIds: ['PGD', 'COREB', 'PRTEAM'] },
